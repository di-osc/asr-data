...
class AudioPcm:
    def __init__(self, data: bytes, sample_rate: int, channels: int = 1) -> None: ...
    @property
    def kind(self) -> str: ...
    @property
    def sample_rate(self) -> int: ...
...
class Waveform:
    ...
    @staticmethod
    def aload_from_path(path: str) -> _AudioLoadTask: ...
    @staticmethod
...
class AudioDoc:
    ...
    def id(self) -> str: ...
    @property
    def source(self) -> AudioPath | AudioUrl | AudioBytes | AudioBase64 | AudioPcm: ...
    @property
    def duration_ms(self) -> int | None: ...
    @duration_ms.setter
    def duration_ms(self, value: int | None) -> None: ...
